...
def run():
    ...
    tab1,tab2,tab3, tab4, tab5, tab6 = st.tabs(['Régression ( Elastic Net )', 'Classification ( RandomForest Classifier )', 'Régression ( XGBoost )', 'Classification ( XGBoost )' ,'SARIMAX', 'RNN Univarié'])
